...
import Item from "../../AdminItem/Item.jsx";
import { getNotBestSellingProducts } from "../../../Slices/bestsellingslice/bestsellingslice.js";
function Addinbestselling() {
  const about = "Add in Best Selling";
  ...
  useEffect(() => {
    console.log("Dispatching get not best selling Products action...");
    dispatch(getNotBestSellingProducts());
  }, []);
...
export default Addinbestselling;
