...
import { getBestSellingProducts } from "../../../Slices/bestsellingslice/bestsellingslice.js";

function Removeproductfrombestselling() {
  const about = "Remove product from best selling";
...
export default Removeproductfrombestselling;
