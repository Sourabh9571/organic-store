...
function Removetrendingproduct() {
  ...
  useEffect(() => {
    console.log("Dispatching gettrendingProducts action...");
            ...
            <table className="border border-gray-400 rounded-sm w-full">
              <thead>
                <tr className="border border-gray-400">
                  ...
                  <th className="border border-gray-400">{about}</th>
                </tr>
              </thead>
              <tbody>
...
export default Removetrendingproduct;
